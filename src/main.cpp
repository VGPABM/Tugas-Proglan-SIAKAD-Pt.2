		...
		case 7:{
			...
			{cin.clear();cin.ignore();cin.ignore();}
				...
				if (menupilihanmatkul == 1){
					...
					cin>>jumlah_sks;if (jumlah_sks >5){cout<<"Besar yang anda masukkan salah!!"; cin.ignore();cin.ignore();}if (cin.fail()){cin.clear();cin.ignore();cin.ignore();}
					...
					cin>>minimalSemester; if (minimalSemester >10){cout<<"Besar yang anda masukkan salah!!"; cin.ignore();cin.ignore();}if (cin.fail()){cin.clear();cin.ignore();cin.ignore();}
					matkul newMatkul(namamatkul, dosenpengajar, deptpengurus, jumlah_sks,jumlahkelas,kuotaterdaftar,minimalSemester);
				...
				cout<<"Pilih matkul untuk edit"<<endl;
				cin>>pilihan;
				pilihan = pilihan-1;
				...
				//cout<<recMatkul[pilihan].getmahasiswaterdaftar()<<endl;
